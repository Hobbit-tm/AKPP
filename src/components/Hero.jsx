      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-24">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
            ...
            гидроблоков и мехатроников с гарантией.Проводим точную диагностику,
            объясняем причину поломки и восстанавливаем коробку с гарантией.
            Подходит для легковых авто, кроссоверов и коммерческого транспорта.
          </p>
